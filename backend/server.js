...
// Initialize cart routes - this format is different from the other routes
require('./routes/kosar.routes')(app);

// Initialize product routes - this format is different from the other routes
require('./routes/termek.routes')(app);

// Initialize coupon routes
require('./routes/kupon.routes')(app);

// Add a direct route for login to match frontend expectations
