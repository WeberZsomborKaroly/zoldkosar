...
// Get the promise-based connection
...
async function debugOrdersQuery() {
    try {
        ...
        // First, check the structure of the rendelesek table
        ...
        // Check the structure of the felhasznalok table
        ...
        // Try the actual query with a simpler version first
        ...
        try {
            ...
            // Try to format the data to see if that's where the error is
