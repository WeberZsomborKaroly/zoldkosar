...
const CouponList = () => {
    ...
    const loadCoupons = async () => {
        setLoading(true);
        try {
            // Ellenőrizzük és javítjuk a token tárolását
            checkAndFixToken();
            
            // Az axiosInstance automatikusan hozzáadja a tokent a kéréshez
            ...
            // Ha 401-es hiba van, akkor valószínűleg lejárt a token
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Form reset és kuponok újratöltése
            setFormData({
                kod: '',
                tipus: 'fix',
                ertek: '',
