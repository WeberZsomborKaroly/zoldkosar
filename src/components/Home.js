        ...
        'Rendelés & Szállítás': [
            {
                ...
                answer: 'A rendelések általában 1-3 munkanapon belül kerülnek kiszállításra. Nagyobb forgalom esetén ez az időtartam legfeljebb 5 munkanapra nőhet. A rendelés leadása után e-mailben értesítést küldünk a rendelésről..'
            },
            {
                id: 2,
                question: 'Hogyan követhetem nyomon a rendelésem?',
                answer: 'Bejelentkezés után a profil fülön megtekintheti a rendelései státuszát.'
            },
            {
                id: 3,
                question: 'Milyen szállítási módok közül választhatok?',
                answer: 'Jelenleg egy szállítási módot kínálunk: futárszolgálat (2-4 munkanap).'
            }
        ],
        'Fizetés': [
            {
                ...
                answer: 'Többféle fizetési módot kínálunk: Bankkártyás fizetés (Visa, Mastercard), Utánvét (készpénzes vagy kártyás fizetés a futárnál).'
            },
            {
                id: 5,
                question: 'Hogyan tudok számlát kérni?',
                answer: 'A rendelés leadása után a profil fülön belül listázza a rendeléseket, amelyeket a felhasználó leadott. Itt van lehetőség számlát kérni a rendelésről, a számlázási adatok megadása után.'
            },
            {
                id: 6,
        ...
        'Egyéb': [
            {
                ...
                answer: 'A weboldal jobb felső sarkában található "Regisztráció" gombra kattintva töltheti ki a regisztrációs űrlapot.'
            },
            {
                id: 11,
                question: 'Elfelejtettem a jelszavamat. Mit tegyek?',
                answer: 'Elfelejtett jelszó esetén, kérjük vegye fel E-mail-ben, vagy telefonon a kapcsolatot az ügyfélszolgálattal!'
            },
            {
                id: 12,
                ...
                <div className="footer-content">
                    <div className="footer-links">
                        <Link to="/privacy-policy" className="privacy-policy-button">
                            <i className="fas fa-shield-alt"></i> Adatkezelési Tájékoztató
                        </Link>
                    </div>
                    <div className="footer-copyright">
                        <p> 2025 ZöldKosár Webáruház. Minden jog fenntartva.</p>
                    </div>
                </div>
            </footer>
        </div>
