...
async function fixCategories() {
    ...
    try {
        ...
        // Javítandó termékek listája kategóriákkal
        const javitasok = [
            ...
            // Édességek kategória - csak a Milka csoki marad
            ...
            // Zöldségek kategória - a vaj tejtermék
            { id: 54, kategoria_id: 5 }, // Vaj -> Tejtermékek
            
            // Étel kategória - zöldségek áthelyezése
            ...
            // Banán áthelyezése Gyümölcsök kategóriába
            { id: 2, kategoria_id: 8 }, // Banán -> Gyümölcsök
        ];
        
        // Végezzük el a javításokat
